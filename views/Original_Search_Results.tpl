    ...
    <td>
        <ul>
            <li>
                ...
                <i>{{each_pmid["_id"]["FullJournalName"]}}</i> {{each_pmid["_id"]["Volume"]}}: {{each_pmid["_id"]["Pages"]}}  &nbsp <a href="http://www.ncbi.nlm.nih.gov/pmc/articles/PMC{{each_pmid['_id']['PMCID']}}/" target="_blank">PMC{{each_pmid["_id"]["PMCID"]}} </a> &nbsp <a href="#" class="show_hide" rel="#slidingDiv_{{each_pmid['_id']['PMCID']}}"> Show Datums </a> <br />
